...
public class EliminarDoctor extends javax.swing.JFrame {
    ...
    private void mostrarDoctor() {
        ...
        for (int i = 0; i < listaDoctor.size(); i++) {
            ...
            cbxEliminar.addItem(listaDoctor.get(i).getNombre() + " " + listaDoctor.get(i).getApellido() + "-" + listaDoctor.get(i).getCODIGO_DOCTOR());
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Doctor a eliminar");
        ...
        cbxEliminar.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jPanel1.add(cbxEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 110, 210, 30));
    ...
    private void btnEliminar() {
        int indice = cbxEliminar.getSelectedIndex(); 
        objDoctorDao.eliminar(listaDoctor.get(indice).getDni(), listaDoctor.get(indice).getCODIGO_DOCTOR());
        mostrarDoctor();
